...
class FunctionsTest < MiniTest::Test
  ...
  def test_length_of_string()
    test_string = "A long string of length 26"
    length_of_string = length_of_string( test_string )
    assert_equal( 26, length_of_string )
  end
  ...
  def test_volume_of_sphere()
    ...
    assert_equal(113.1, volume_of_sphere_three)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_to_celsius_32 = fahrenheit_to_celsius(32)
    assert_equal(0.0, fahrenheit_to_celsius_32)
  end
